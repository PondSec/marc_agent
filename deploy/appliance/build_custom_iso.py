...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--router-model-name", default="qwen3:8b")
    ...
    parser.add_argument("--ollama-context-length", default="4096")
    parser.add_argument("--ollama-num-ctx", default="4096")
    ...
    parser.add_argument("--ollama-max-loaded-models", default="2")
